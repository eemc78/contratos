...
<body class="login-page">
    <div class="login-box">
        ...
        <div class="login-box-body">
            <p class="login-box-msg">Reconfigurar la Clave</p>
            <form action="{{ url('/password/email') }}" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-8">
                        <button type="submit" class="btn btn-primary btn-block btn-flat">Enviar un enlace  al correo para Cambiar la Clave</button>
                    </div><!-- /.col -->
                    <div class="col-xs-2">
                    </div><!-- /.col -->
                </div>
