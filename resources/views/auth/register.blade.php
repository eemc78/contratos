    ...
    <div class="register-box">
        ...
        @if (count($errors) > 0)
            <div class="alert alert-danger">
                <strong>Whoops!</strong> Hay algun problema con sus datos.<br><br>
                <ul>
        ...
        <div class="register-box-body">
            <p class="login-box-msg">Registrar Super Admin</p>
                ...
                <div class="row">
                    <div class="col-xs-8">
                        <div class="checkbox icheck">
                            <label>
                                <input type="checkbox"> Confirmo que he leido y Acepto los terminos
                            </label>
                        </div>
                    </div><!-- /.col -->
                    <div class="col-xs-4">
