...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		...
		<div class="col-md-1 actions">
			@la_access("Ters", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/ters/'.$ter->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Ters", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.ters.destroy', $ter->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/ters') }}" data-toggle="tooltip" data-placement="right" title="Back to Ters"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'razonsocial')
						@la_display($module, 'direccion')
						@la_display($module, 'telefono')
						@la_display($module, 'representante')
						@la_display($module, 'Nit')
					</div>
				</div>
			</div>
		</div>
