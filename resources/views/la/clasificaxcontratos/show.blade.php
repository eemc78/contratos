...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $clasificaxcontrato->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Clasificaxcontratos", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/clasificaxcontratos/'.$clasificaxcontrato->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Clasificaxcontratos", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.clasificaxcontratos.destroy', $clasificaxcontrato->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/clasificaxcontratos') }}" data-toggle="tooltip" data-placement="right" title="Back to Clasificaxcontratos"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'idclasificador')
					</div>
				</div>
			</div>
		</div>
