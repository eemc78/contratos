...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $contrato->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Contratos", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/contratos/'.$contrato->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Contratos", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.contratos.destroy', $contrato->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/contratos') }}" data-toggle="tooltip" data-placement="right" title="Back to Contratos"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'idcontrato')
						@la_display($module, 'ter')
						@la_display($module, 'contacto')
						@la_display($module, 'direccion')
						@la_display($module, 'telefono')
						@la_display($module, 'descripcion')
						@la_display($module, 'tipocontrato')
						@la_display($module, 'objetocontrato')
						@la_display($module, 'duracion')
						@la_display($module, 'fechafin')
						@la_display($module, 'valor')
						@la_display($module, 'revisado')
						@la_display($module, 'fecharev')
						@la_display($module, 'juridico')
						@la_display($module, 'fechajur')
						@la_display($module, 'aprobado')
						@la_display($module, 'fechaapr')
						@la_display($module, 'fechaadi')
						@la_display($module, 'detalleadicion')
