...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $proceso->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Procesos", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/procesos/'.$proceso->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Procesos", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.procesos.destroy', $proceso->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/procesos') }}" data-toggle="tooltip" data-placement="right" title="Back to Procesos"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'tipoproceso')
						@la_display($module, 'detalle')
						@la_display($module, 'usuario')
						@la_display($module, 'fecha')
						@la_display($module, 'proveedor')
						@la_display($module, 'estadoverifica')
						@la_display($module, 'ordencompra')
						@la_display($module, 'factura')
					</div>
				</div>
			</div>
		</div>
