	...
	<form action="{{route(config('laraadmin.adminRoute').'.la_configs.store')}}" method="POST">
		...
		<div class="box box-warning">
			<div class="box-header with-border">
				<h3 class="box-title">CONFIGURACION DE CONTRATOS</h3>
			</div>
			<!-- /.box-header -->
			<div class="box-body">
				{{ csrf_field() }}
				...
				<div class="form-group">
					<label>Avisar antes de vencimiento (en meses) </label>
					<input type="text" class="form-control" placeholder="meses" name="mesesparavencer" value="{{$configs->mesesparavencer}}">
				</div>
