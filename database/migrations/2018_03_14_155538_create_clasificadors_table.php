...
class CreateClasificadorsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Clasificadors", 'clasificadors', 'clasificador', 'fa-stack-overflow', [
            ["clasificador", "nombreclasificador", "TextField", false, "", 0, 256, false],
        ]);
    ...
    {
        if (Schema::hasTable('clasificadors')) {
